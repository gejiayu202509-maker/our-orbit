...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  const enterWorld=(id)=>{const stage=document.querySelector('.galaxy-stage');if(!stage||stage.classList.contains('is-entering'))return;const focus={timeline:[.22,.63],map:[.60,.78],room:[.86,.60],gallery:[.80,.34],diary:[.25,.27],letters:[.45,.21],stats:[.91,.20],wishes:[.11,.15],signal:[.65,.27]}[id]||[.5,.5];const scale=3.55;stage.style.setProperty('--jump-x',`${focus[0]*100}%`);stage.style.setProperty('--jump-y',`${focus[1]*100}%`);stage.style.setProperty('--fly-x',`${50-focus[0]*scale*100}%`);stage.style.setProperty('--fly-y',`${50-focus[1]*scale*100}%`);stage.classList.add('is-entering');window.setTimeout(()=>window.location.assign(`world.html?world=${encodeURIComponent(id)}`),1390)};
